...
- **Coqui TTS** (optional, for voice cloning):
  - `COQUITTS_MODEL_NAME` - TTS model name
  - `COQUITTS_OUTPUT_FORMAT` - Audio output format (wav/mp3)
...
COQUITTS_MODEL_NAME = 'tts_models/multilingual/multi-dataset/xtts_v2'
COQUITTS_OUTPUT_FORMAT = 'wav'  # Options: wav, mp3
